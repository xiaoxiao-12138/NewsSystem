...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <form style="padding-top: 50px; padding-left: 50px;" th:action="@{/admin/newsUpdate}">
                <!--隐藏域-->
                <input name="id" th:value="${news.getId()}" hidden="hidden">
                <strong class="mc-ui-flex-center" style="padding-bottom: 20px;">修改新闻</strong><div class="row mt-sm-2">
                ...
                <div class="col-md-11 col-lg-11 col-xl-11 col-sm-12" style="padding-right: 200px;">
                    <input class="form-control" type="text" aria-describedby="passwordHelp" placeholder="请输入标题" name="title" th:value="${news.getTitle()}" required="required"/>
                </div>
            </div>
                <div class="row mt-sm-2">
                    ...
                    <div class="col-md-11 col-lg-11 col-xl-11 col-sm-12" style="padding-right: 200px;">
                        <select class="form-control" name="cid">
                            <option th:each="category:${categorys}" th:text="${category.getCategoryName()}" th:value="${category.getId()}" th:selected="${news.getCid()}==${category.getId()}">2</option>
                        </select>
                    </div>
                </div>
                <div class="row mt-sm-2">
                    ...
                    <div class="col-md-11 col-lg-11 col-xl-11 col-sm-12" style="padding-right: 200px;">
                        <textarea class="form-control" rows="3" th:text="${news.getContent()}" name="content" placeholder="请输入内容" required="required"></textarea>
                    </div>
                </div>
                <div class="row mt-sm-2">
                    <div class="col-md-1 col-lg-1 col-xl-1 col-sm-12 text-left align-self-md-center">
                    ...
                    <div class="col-md-11 col-lg-11 col-xl-11 col-sm-12" style="padding-right: 200px;">
                        <input class="form-control" type="text" aria-describedby="passwordHelp" placeholder="请输入来源" th:value="${news.getSource()}" name="source" required="required"/>
                    </div>
                </div>
